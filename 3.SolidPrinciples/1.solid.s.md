...
- A Restaurant Manager:
  ...
  - Cleans tables
  - Handles billing
- If cooking rules change → manager changes
- If billing rules change → manager changes
...
SRP is NOT About Number of Classes

❌ Bad thinking:

“SRP creates too many files”

✅ Correct thinking:

“SRP isolates change”

Large systems need more classes to avoid cascading changes.
